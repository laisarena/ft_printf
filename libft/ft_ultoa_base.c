...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/08/16 16:31:17 by laisarena         #+#    #+#             */
/*   Updated: 2020/08/16 16:36:36 by laisarena        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_countdigits(unsigned long l, int len)
{
	int	count;

	count = 1;
	while (l >= (unsigned long)len)
	{
		l = l / len;
		count++;
	}
